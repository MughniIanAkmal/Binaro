...
<div class="p-6">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <div class="flex items-center gap-2 text-xs font-semibold mb-2">
                ...
                <span class="text-gray-400">Dashboard > Jadwal Pelajaran > Tambah Jadwal</span>
            </div>
            <h1 class="text-2xl font-bold text-gray-800">Tambah Jadwal Pelajaran</h1>
            <p class="text-sm text-gray-500 mt-1">Lengkapi formulir di bawah untuk menambahkan jadwal mata pelajaran baru.</p>
        </div>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
        ...
        <form action="{{ route('jadwal.store') }}" method="POST" class="px-6 pt-2 pb-6 space-y-4">
            ...
            <!-- Input Jam -->
            <div>
                <label for="jam" class="block text-sm font-semibold text-gray-700 mb-1.5">Jam Pelajaran</label>
                <input
                    type="text"
                    name="jam"
                    id="jam"
                    ...
                    title="Format jam harus sesuai contoh: 07.00-08.00"
            ...
            <div class="flex justify-end gap-3 pt-3 border-t border-gray-100">
                ...
                <button type="submit" class="bg-slate-900 hover:bg-slate-800 text-white px-5 py-2.5 rounded-xl text-sm font-medium transition flex items-center gap-2">
                    💾 Simpan Jadwal
                </button>
            </div>
        </form>
